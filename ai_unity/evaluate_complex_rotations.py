...
MODEL_FACTORIES = {
    ...
    "RealCapsuleLargeL1": (RealCapsuleNetLargeL1, "img"),
    "RealCapsuleControlV2": (RealCapsuleNetControlV2, "img"),
    "RealCapsuleControlV2Norm": (RealCapsuleNetControlV2Norm, "img"),
...
MODEL_CHOICES = {
    ...
    "real-large-l1": "RealCapsuleLargeL1",
    "control-v2": "RealCapsuleControlV2",
    "control-v2-norm": "RealCapsuleControlV2Norm",
